...
# --- ABA 1: PERÍCIA DE GABARITOS (VERSÃO V49.5 - TRIAGEM DUPLA) ---
    with tab_pericia:
        ...
        if not t_sel or not at_sel:
            ...
            if pendentes.empty:
                ...
                if material_ref is not None:
                    ...
                    def extrair_gab_v49_5(texto, is_pei=False):
                        # Se o aluno for PEI, busca a tag específica, senão busca a regular
                    ...
                    # A mágica: extrai o gabarito correto do material escolhido baseado no perfil do aluno
                    gab_alvo = extrair_gab_v49_5(txt_ref, is_pei_aluno)
        ...
        if not t_sel_r or not at_sel_r:
            ...
            if respostas_brutas.empty:
                ...
                if query_mat.empty:
                    ...
                    gab_ativo = extrair_gab_v73_universal(txt_prova, is_pei_view)
                ...
                # --- PARTE B: DIAGNÓSTICO INDIVIDUAL ---
                st.markdown("---")
                ...
                for _, alu in alunos_turma.iterrows():
                    ...
                    if reg_aluno.empty:
                        ...
                        if not m_ref_query.empty:
                            ...
                            gab_ref_alu = extrair_gab_v73_universal(str(m_ref['CONTEUDO']), is_pei_alu)
                            ...
                            lacunas_txt = "⚠️ Material de ref. não encontrado"
