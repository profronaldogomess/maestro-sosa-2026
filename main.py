    ...
    with tab_pericia:
        ...
        if not t_sel or not at_sel:
            ...
            with sub_cap:
                ...
                if pendentes.empty: st.success("✅ Todos os alunos desta turma foram escaneados!")
                else:
                    al_sel = st.selectbox("👤 Selecionar Aluno:", pendentes['NOME_ALUNO'].tolist(), key=f"al_p_{v}")
